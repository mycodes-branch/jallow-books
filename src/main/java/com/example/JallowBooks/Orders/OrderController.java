...
import com.example.JallowBooks.errors.InternalServerError;
...
public class OrderController {
    ...
    @PostMapping("/create")
    public ResponseEntity<TheOrder> createOrder(
        ...
        try {
            ...
            throw new InternalServerError("Sorry something went wrong");
        }
        TheOrder order = orderService.createOrder(request.getUserId(), this.bookIds);
